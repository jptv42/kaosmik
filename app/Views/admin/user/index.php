...
<div class="row mt-3">
    <div class="col">
        <div class="card">
        <table class="table table-responsive table-sm table-hover table-striped" data-toggle="table" data-search="true" data-pagination="true">
            <thead>
            <tr>
                <th>#</th>
                <th>Username</th>
            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    <td><?=$user->id;?></td>
                    <td><?=$user->username;?></td>
                    <td><?= $user->isActivated() ? "<i class='text-success fa-solid fa-check'></i>" : "<i class='text-danger fa-solid fa-xmark'></i>"; ?></td>
